...
<div id="myTabContent" class="tab-content">
  <?php if($config['twitter_show'] && $config['first']=='twitter'): ?>
  <div class="tab-pane active <?php echo $config['twitter_class']; ?>" id="twitter">
  ...
  <?php endif; ?>
  <?php if($config['facebook_show']): ?>
  <div class="tab-pane <?php echo $config['facebook_class']; ?>" id="facebook">
  ...
  <?php endif; ?>
  <?php if($config['twitter_show'] && $config['first']!='twitter'): ?>
  <div class="tab-pane <?php echo $config['twitter_class']; ?>" id="twitter">
    <div class="twitter-content">
...
jQuery(document).ready(function(){
    jQuery('#twitter a').click(function (e) {
       e.preventDefault();
      jQuery(this).tab('show');
    })
    jQuery('#facebook a').click(function (e) {
       e.preventDefault();
      jQuery(this).tab('show');
    })
    jQuery('#myTab a[href="#<?php echo $config["active"] ?>"]').tab('show');
});
 //]]>
