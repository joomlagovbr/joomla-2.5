...
<div class="content-header-options-1 row-fluid">
	<div class="documentByLine span7">
		...
		<?php if ($params->get('show_modify_date')) : ?>
			...
			<?php if(($params->get('show_publish_date')) or ($params->get('show_hits')) or ($params->get('show_category'))): ?><span class="separator">|</span><?php endif; ?>
		<?php endif; ?>	
		...
		<?php if ($params->get('show_publish_date')) : ?>
			...
			<?php if(($params->get('show_hits'))): ?><span class="separator">|</span><?php endif; ?>
		<?php endif; ?>	
